...
public class HighAlgaeIntake extends Command {
  ...
  public HighAlgaeIntake() {
    wrist = new WristCommand(WristState.HIGHALGAEINTAKE);
    pivot = new PivotCommand(PivotState.HIGHALGAEINTAKE);
    elevator = new ElevatorCommand(ElevatorState.HIGHALGAEINTAKE);
