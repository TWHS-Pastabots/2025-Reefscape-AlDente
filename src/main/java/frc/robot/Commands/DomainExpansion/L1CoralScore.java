...
public class L1CoralScore extends Command {
  ...
  public L1CoralScore() {
    wrist = new WristCommand(WristState.L1CORALSCORE);
    pivot = new PivotCommand(PivotState.L1CORALSCORE);
    elevator = new ElevatorCommand(ElevatorState.L1CORALSCORE);
