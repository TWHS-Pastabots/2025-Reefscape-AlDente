...
public class L2CoralScore1 extends Command {
  ...
  public L2CoralScore1() {
    wrist = new WristCommand(WristState.L2CORALSCORE);
    pivot = new PivotCommand(PivotState.L2CORALSCORE);
    elevator = new ElevatorCommand(ElevatorState.L2CORALSCORE);
