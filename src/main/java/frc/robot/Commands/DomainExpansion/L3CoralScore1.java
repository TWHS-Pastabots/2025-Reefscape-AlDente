...
public class L3CoralScore1 extends Command {
  ...
  public L3CoralScore1() {
    wrist = new WristCommand(WristState.L3CORALSCORE);
    pivot = new PivotCommand(PivotState.L3CORALSCORE);
    elevator = new ElevatorCommand(ElevatorState.L3CORALSCORE);
